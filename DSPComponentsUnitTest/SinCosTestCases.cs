...
namespace DSPComponentsUnitTest
{
    ...
    public class SinCosTestCases
    {
        ...
        public void SinCosTestMethod1()
        {
            ...
            var expectedOutput = UnitTestUtitlities.LoadSignal("E:/ahmed/dsp/fcisdsp-dsp.toolbox-78ddd969882b/DSPToolbox/DSPComponentsUnitTest/TestingSignals/Sin.ds");
        ...
        public void SinCosTestMethod2()
        {
            ...
            obj.Run();
            var expectedOutput = UnitTestUtitlities.LoadSignal("E:/ahmed/dsp/fcisdsp-dsp.toolbox-78ddd969882b/DSPToolbox/DSPComponentsUnitTest/TestingSignals/Cos.ds");
            Assert.IsTrue(UnitTestUtitlities.SignalsSamplesAreEqual(expectedOutput.Samples, obj.samples));
